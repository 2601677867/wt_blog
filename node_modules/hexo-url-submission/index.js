...
hexo.config.url_submission = Object.assign({
    ...
    channel: ['baidu', 'bing', 'shenma', 'google'], // included channels are `baidu`, `google`, `bing`, `shenma`
    prefix: ['post', 'wiki'],
    count: 10,
    proxy: '',
...
hexo.extend.deployer.register('us_shenma_deployer', require('./lib/shenma_deployer')) // google api deployer
